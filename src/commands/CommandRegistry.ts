...
type BuilderConstructor<T extends BaseCommand, B extends CommandBuilder<T>> = new (...args: any[]) => B;
...
export class CommandRegistry {
  ...
  private builderMap: Map<string, BuilderConstructor<BaseCommand, CommandBuilder<BaseCommand>>> = new Map();
  ...
  public registerCommand<T extends BaseCommand>(
    ...
    this.commandMap.set(name, commandConstructor as CommandConstructor<BaseCommand>);
  }
  ...
  public registerBuilder<T extends BaseCommand, B extends CommandBuilder<T>>(
    ...
    this.builderMap.set(
      commandType, 
      builderConstructor as BuilderConstructor<BaseCommand, CommandBuilder<BaseCommand>>
    );
  }
   ...
   */
  public getCommandConstructor(name: string): CommandConstructor<BaseCommand> | undefined {
   ...
   */
  public createBuilder(commandType: string, ...args: any[]): CommandBuilder<BaseCommand> | undefined {
   ...
   */
  public async findExecutor(command: BaseCommand): Promise<CommandExecutor | undefined> {
